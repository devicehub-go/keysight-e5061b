...
*/
func (v *E5061B) Disconnect() error {
...
*/
func (v *E5061B) IsConnected() bool {
...
*/
func (v *E5061B) Write(message string) error {
	if !v.IsConnected() {
...
*/
func (v *E5061B) WriteSequence(messages []string) error {
...
*/
func (v *E5061B) Query(message string) ([]byte, error) {
	v.mutex.Lock()
...
*/
func (v *E5061B) QueryByteSequence(message string) ([]byte, error) {
	v.mutex.Lock()
	defer v.mutex.Unlock()
